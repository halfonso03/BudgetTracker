...
const Button = ({
  ...
  if (variation == 'primary') {
    ...
    classes +=
      'text-neutral-700 bg-neutral-200 border border-neutral-300 shadow-md hover:bg-neutral-300 hover:border-gray-300 disabled:opacity-70 disabled:text-neutral-500 dark:bg-transparent dark:text-white dark:border-gray-600 dark:hover:bg-neutral-800 dark:hover:border-gray-600 transition-all duration-200';
  } else if (variation == 'danger') {
    classes +=
      'text-neutral-100 bg-red-500 border border-red-600 hover:bg-red-700 shadow-md transition-all duration-300 disabled:opacity-50';
  }
