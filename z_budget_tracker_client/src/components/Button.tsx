...
const Button = ({
  ...
  if (variation == 'primary') {
    classes +=
      ' text-neutral-50 border bg-blue-600 border-blue-400 hover:bg-blue-500 dark:bg-green-800 disabled:opacity-50 dark:disabled:bg-green-700 dark:border-green-500 shadow-md dark:hover:bg-green-700 transition-all duration-300';
