...
public partial class LoadReport3Request
{
    ...
    public LoadReport3Request(TrustedUserHeader TrustedUserHeader, string Report, string HistoryID)
    {
        this.TrustedUserHeader = TrustedUserHeader;
        this.Report = Report;
        this.HistoryID = HistoryID;
...
public partial class LoadReport3Response
{
    ...
    public LoadReport3Response(ExecutionHeader ExecutionHeader, ServerInfoHeader ServerInfoHeader, ExecutionInfo3 executionInfo)
    {
        this.ExecutionHeader = ExecutionHeader;
        this.ServerInfoHeader = ServerInfoHeader;
        this.executionInfo = executionInfo;
...
public partial class LoadReportDefinition3Request
{
    ...
    public LoadReportDefinition3Request(TrustedUserHeader TrustedUserHeader, byte[] Definition)
    {
        this.TrustedUserHeader = TrustedUserHeader;
        this.Definition = Definition;
    }
...
public partial class LoadReportDefinition3Response
{
    ...
    public LoadReportDefinition3Response(ExecutionHeader ExecutionHeader, ServerInfoHeader ServerInfoHeader, ExecutionInfo3 executionInfo, Warning[] warnings)
    {
        this.ExecutionHeader = ExecutionHeader;
        this.ServerInfoHeader = ServerInfoHeader;
        this.executionInfo = executionInfo;
...
public partial class SetExecutionCredentials3Request
{
    ...
    public SetExecutionCredentials3Request(ExecutionHeader ExecutionHeader, TrustedUserHeader TrustedUserHeader, DataSourceCredentials[] Credentials)
    {
        this.ExecutionHeader = ExecutionHeader;
        this.TrustedUserHeader = TrustedUserHeader;
        this.Credentials = Credentials;
...
public partial class SetExecutionCredentials3Response
{
    ...
    public SetExecutionCredentials3Response(ServerInfoHeader ServerInfoHeader, ExecutionInfo3 executionInfo)
    {
        this.ServerInfoHeader = ServerInfoHeader;
        this.executionInfo = executionInfo;
    }
...
public partial class SetExecutionParameters3Request
{
    ...
    public SetExecutionParameters3Request(ExecutionHeader ExecutionHeader, TrustedUserHeader TrustedUserHeader, ParameterValue[] Parameters, string ParameterLanguage)
    {
        this.ExecutionHeader = ExecutionHeader;
        this.TrustedUserHeader = TrustedUserHeader;
        this.Parameters = Parameters;
...
public partial class SetExecutionParameters3Response
{
    ...
    public SetExecutionParameters3Response(ServerInfoHeader ServerInfoHeader, ExecutionInfo3 executionInfo)
    {
        this.ServerInfoHeader = ServerInfoHeader;
        this.executionInfo = executionInfo;
    }
...
public partial class ResetExecution3Request
{
    ...
    public ResetExecution3Request(ExecutionHeader ExecutionHeader, TrustedUserHeader TrustedUserHeader)
    {
        this.ExecutionHeader = ExecutionHeader;
        this.TrustedUserHeader = TrustedUserHeader;
    }
...
public partial class ResetExecution3Response
{
    ...
    public ResetExecution3Response(ServerInfoHeader ServerInfoHeader, ExecutionInfo3 executionInfo)
    {
        this.ServerInfoHeader = ServerInfoHeader;
        this.executionInfo = executionInfo;
    }
...
public partial class DeliverReportItemRequest
{
    ...
    public DeliverReportItemRequest(ExecutionHeader ExecutionHeader, TrustedUserHeader TrustedUserHeader, string Format, string DeviceInfo, ExtensionSettings ExtensionSettings, string Description, string EventType, string MatchData)
    {
        this.ExecutionHeader = ExecutionHeader;
        this.TrustedUserHeader = TrustedUserHeader;
        this.Format = Format;
...
public partial class DeliverReportItemResponse
{
    ...
    public DeliverReportItemResponse(ServerInfoHeader ServerInfoHeader)
    {
        this.ServerInfoHeader = ServerInfoHeader;
    }
}
...
public partial class GetExecutionInfo3Request
{
    ...
    public GetExecutionInfo3Request(ExecutionHeader ExecutionHeader, TrustedUserHeader TrustedUserHeader)
    {
        this.ExecutionHeader = ExecutionHeader;
        this.TrustedUserHeader = TrustedUserHeader;
    }
...
public partial class GetExecutionInfo3Response
{
    ...
    public GetExecutionInfo3Response(ServerInfoHeader ServerInfoHeader, ExecutionInfo3 executionInfo)
    {
        this.ServerInfoHeader = ServerInfoHeader;
        this.executionInfo = executionInfo;
    }
...
public partial class LoadDrillthroughTarget3Request
{
    ...
    public LoadDrillthroughTarget3Request(ExecutionHeader ExecutionHeader, TrustedUserHeader TrustedUserHeader, string DrillthroughID)
    {
        this.ExecutionHeader = ExecutionHeader;
        this.TrustedUserHeader = TrustedUserHeader;
        this.DrillthroughID = DrillthroughID;
...
public partial class LoadDrillthroughTarget3Response
{
    ...
    public LoadDrillthroughTarget3Response(ExecutionHeader ExecutionHeader, ServerInfoHeader ServerInfoHeader, ExecutionInfo3 ExecutionInfo)
    {
        this.ExecutionHeader = ExecutionHeader;
        this.ServerInfoHeader = ServerInfoHeader;
        this.ExecutionInfo = ExecutionInfo;
...
public partial class Sort3Request
{
    ...
    public Sort3Request(ExecutionHeader ExecutionHeader, TrustedUserHeader TrustedUserHeader, string SortItem, SortDirectionEnum Direction, bool Clear, PageCountMode PaginationMode)
    {
        this.ExecutionHeader = ExecutionHeader;
        this.TrustedUserHeader = TrustedUserHeader;
        this.SortItem = SortItem;
...
public partial class Sort3Response
{
    ...
    public Sort3Response(ServerInfoHeader ServerInfoHeader, int PageNumber, string ReportItem, ExecutionInfo3 ExecutionInfo)
    {
        this.ServerInfoHeader = ServerInfoHeader;
        this.PageNumber = PageNumber;
        this.ReportItem = ReportItem;
...
public partial class ReportExecutionServiceSoapClient : System.ServiceModel.ClientBase<ReportExecutionServiceSoap>, ReportExecutionServiceSoap
{
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    System.Threading.Tasks.Task<LoadReport3Response> ReportExecutionServiceSoap.LoadReport3Async(LoadReport3Request request)
    {
        return base.Channel.LoadReport3Async(request);
    }
    
    public System.Threading.Tasks.Task<LoadReport3Response> LoadReport3Async(TrustedUserHeader TrustedUserHeader, string Report, string HistoryID)
    {
        LoadReport3Request inValue = new LoadReport3Request();
        inValue.TrustedUserHeader = TrustedUserHeader;
        inValue.Report = Report;
        inValue.HistoryID = HistoryID;
        return ((ReportExecutionServiceSoap)(this)).LoadReport3Async(inValue);
    }
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    System.Threading.Tasks.Task<SetExecutionCredentials3Response> ReportExecutionServiceSoap.SetExecutionCredentials3Async(SetExecutionCredentials3Request request)
    {
        return base.Channel.SetExecutionCredentials3Async(request);
    }
    
    public System.Threading.Tasks.Task<SetExecutionCredentials3Response> SetExecutionCredentials3Async(ExecutionHeader ExecutionHeader, TrustedUserHeader TrustedUserHeader, DataSourceCredentials[] Credentials)
    {
        SetExecutionCredentials3Request inValue = new SetExecutionCredentials3Request();
        inValue.ExecutionHeader = ExecutionHeader;
        inValue.TrustedUserHeader = TrustedUserHeader;
        inValue.Credentials = Credentials;
        return ((ReportExecutionServiceSoap)(this)).SetExecutionCredentials3Async(inValue);
    }
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    System.Threading.Tasks.Task<SetExecutionParameters3Response> ReportExecutionServiceSoap.SetExecutionParameters3Async(SetExecutionParameters3Request request)
    {
        return base.Channel.SetExecutionParameters3Async(request);
    }
    
    public System.Threading.Tasks.Task<SetExecutionParameters3Response> SetExecutionParameters3Async(ExecutionHeader ExecutionHeader, TrustedUserHeader TrustedUserHeader, ParameterValue[] Parameters, string ParameterLanguage)
    {
        SetExecutionParameters3Request inValue = new SetExecutionParameters3Request();
        inValue.ExecutionHeader = ExecutionHeader;
        inValue.TrustedUserHeader = TrustedUserHeader;
        inValue.Parameters = Parameters;
        inValue.ParameterLanguage = ParameterLanguage;
        return ((ReportExecutionServiceSoap)(this)).SetExecutionParameters3Async(inValue);
    }
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    System.Threading.Tasks.Task<ResetExecution3Response> ReportExecutionServiceSoap.ResetExecution3Async(ResetExecution3Request request)
    {
        return base.Channel.ResetExecution3Async(request);
    }
    
    public System.Threading.Tasks.Task<ResetExecution3Response> ResetExecution3Async(ExecutionHeader ExecutionHeader, TrustedUserHeader TrustedUserHeader)
    {
        ResetExecution3Request inValue = new ResetExecution3Request();
        inValue.ExecutionHeader = ExecutionHeader;
        inValue.TrustedUserHeader = TrustedUserHeader;
        return ((ReportExecutionServiceSoap)(this)).ResetExecution3Async(inValue);
    }
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    System.Threading.Tasks.Task<DeliverReportItemResponse> ReportExecutionServiceSoap.DeliverReportItemAsync(DeliverReportItemRequest request)
    {
        return base.Channel.DeliverReportItemAsync(request);
    }
    
    public System.Threading.Tasks.Task<DeliverReportItemResponse> DeliverReportItemAsync(ExecutionHeader ExecutionHeader, TrustedUserHeader TrustedUserHeader, string Format, string DeviceInfo, ExtensionSettings ExtensionSettings, string Description, string EventType, string MatchData)
    {
        DeliverReportItemRequest inValue = new DeliverReportItemRequest();
        inValue.ExecutionHeader = ExecutionHeader;
        inValue.TrustedUserHeader = TrustedUserHeader;
        ...
        return ((ReportExecutionServiceSoap)(this)).DeliverReportItemAsync(inValue);
    }
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    System.Threading.Tasks.Task<GetExecutionInfo3Response> ReportExecutionServiceSoap.GetExecutionInfo3Async(GetExecutionInfo3Request request)
    {
        return base.Channel.GetExecutionInfo3Async(request);
    }
    
    public System.Threading.Tasks.Task<GetExecutionInfo3Response> GetExecutionInfo3Async(ExecutionHeader ExecutionHeader, TrustedUserHeader TrustedUserHeader)
    {
        GetExecutionInfo3Request inValue = new GetExecutionInfo3Request();
        inValue.ExecutionHeader = ExecutionHeader;
        inValue.TrustedUserHeader = TrustedUserHeader;
        return ((ReportExecutionServiceSoap)(this)).GetExecutionInfo3Async(inValue);
    }
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    System.Threading.Tasks.Task<LoadDrillthroughTarget3Response> ReportExecutionServiceSoap.LoadDrillthroughTarget3Async(LoadDrillthroughTarget3Request request)
    {
        return base.Channel.LoadDrillthroughTarget3Async(request);
    }
    
    public System.Threading.Tasks.Task<LoadDrillthroughTarget3Response> LoadDrillthroughTarget3Async(ExecutionHeader ExecutionHeader, TrustedUserHeader TrustedUserHeader, string DrillthroughID)
    {
        LoadDrillthroughTarget3Request inValue = new LoadDrillthroughTarget3Request();
        inValue.ExecutionHeader = ExecutionHeader;
        inValue.TrustedUserHeader = TrustedUserHeader;
        inValue.DrillthroughID = DrillthroughID;
        return ((ReportExecutionServiceSoap)(this)).LoadDrillthroughTarget3Async(inValue);
    }
    ...
    private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
    {
        if ((endpointConfiguration == EndpointConfiguration.ReportExecutionServiceSoap))
        {
            return new System.ServiceModel.EndpointAddress("http://172.21.6.67/ReportServer/ReportExecution2005.asmx");
        }
        if ((endpointConfiguration == EndpointConfiguration.ReportExecutionServiceSoap12))
        {
            return new System.ServiceModel.EndpointAddress("http://172.21.6.67/ReportServer/ReportExecution2005.asmx");
